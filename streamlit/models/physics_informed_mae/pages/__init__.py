"""
Model pages module for Physics-Informed MAE
"""
...
spec = importlib.util.spec_from_file_location('pim_architecture', arch_path)
...
spec = importlib.util.spec_from_file_location('pim_documentation', doc_path)
...
spec = importlib.util.spec_from_file_location('pim_examples', ex_path)
...
spec = importlib.util.spec_from_file_location('pim_metrics', met_path)
